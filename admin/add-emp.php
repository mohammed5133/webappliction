...
<?php  
        ...
        $nameErr = $emailErr = $passErr = $salaryErr= $DepartmentNameErr= $phoneErr="";
        $name = $email = $dob = $gender = $pass = $salary = $DepartmentName = $phone ="";
        ...
        if( $_SERVER["REQUEST_METHOD"] == "POST" ){
            ...
            if( !empty($name) && !empty($email) && !empty($pass) && !empty($salary) && !empty($phone)){
                ...
                if( mysqli_num_rows($r) > 0 ){
                    ...
                    $sql = "INSERT INTO employee( name , email , password , dob, gender , salary, DepartmentName ) VALUES( '$name' , '$email' , '$pass' , '$dob' , '$gender', '$salary','$DepartmentName' )  ";
                    $result = mysqli_query($conn , $sql);
                    if($result){
                     $name = $email = $dob = $gender = $pass = $salary = $DepartmentName = "";
                        echo "<script>
