                    ...
                    <div class="form-input-content">
                        <div class="card login-form mt-5">
                            <div class="card-body shadow">   
                                    ...
                                    <h2 class="text-center pb-4">نظام إدارة الموظفين</h2>
                                ...
                                <div class="container mt-4">
                                  ...
                                  <div class="btn-toolbar justify-content-between">
                                        <div class="btn-group">
                                            <a href="employee/dashboard.php" class="btn btn-primary btn-lg">تسجيل الدخول كموظف </a>
                                        </div>

                                        <div class="btn-group">
                                        
                                            <a href="admin/dashboard.php" class="btn btn-primary btn-lg">تسجيل الدخول للمدير</a>
                                        </div>
