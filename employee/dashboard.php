...
<div class="container">
    ...
    <div class="row mt-5">
        <div class="col-4">
            <div class="card shadow " style="width: 18rem;">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item text-center"> <b>ASP Status</b> </li>
                    <li class="list-group-item">Upcoming ASP on :  <?php echo  $upcoming_leave_status ; ?>  </li>
                    <li class="list-group-item">Last ASP Status :  <?php echo ucwords($last_leave_status) ;  ?> </li>
                </ul>
            </div>
        </div>
        <div class="col-4">
            <div class="card shadow " style="width: 18rem;">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item text-center"> <b>Applied ASP</b> </li>
        ...
        <div class="col-4">
            <div class="card shadow " style="width: 18rem;">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item text-center"> <b>الموظفين</b>  </li>
                    <li class="list-group-item">مجموع الموظفين : <?php echo mysqli_num_rows($total_emp); ?></li>
                    <li class="list-group-item text-center"><a href="view-employee.php"> <b>عرض كل الموظفين</b></a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="col-12">
            <div class=" text-center my-3 "> <h4>لوحة الموظفين</h4> </div>
