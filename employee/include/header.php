                   ...
                   <br> <br>       
                    ...
                    <li>
                        <a href="./leave-status.php" >
                            <i class="fa fa-tasks menu-icon"></i><span class="nav-text">التظلم</span>
                        </a>
                    </li>

                    <li>
                        <a href="./apply-leave.php" >
                            <i class="fa fa-paper-plane menu-icon"></i><span class="nav-text">تقديم تظلم</span>
                        </a>
                    </li>

                    <li>
                        <a href="./view-employee.php" >
                            <i class="fa fa-list-ul menu-icon"></i><span class="nav-text">عرض كل الموظفين</span>
                        </a>
                    </li>
